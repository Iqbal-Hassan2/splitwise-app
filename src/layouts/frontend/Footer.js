...
export function Footer() {
  return (
    <footer className="mt-20">
        ...
        <div className="px-7 flex w-full justify-between text-sm leading-tight lg:justify-start lg:leading-relaxed lg:pl-0">
          ...
          <div className="lg:px-8">
            ...
            <ul className="text-grey-light leading-normal">
              ...
              <li>
                <a href="/subscriptions/new">Splitwise Pro</a>
              </li>
              <li>
                <a href="/pay">
                  <span
                    className="translation_missing"
                    title="translation missing: en.splitwise_pay"
                  >
                    Splitwise Pay
                  </span>
                </a>
          ...
          <div className="lg:pl-8">
            ...
            <ul className="text-grey-light leading-normal">
              ...
              <li className="mt-2">
                <a
                  href="https://twitter.com/splitwise"
                ...
                <a
                  href="https://facebook.com/splitwise"
                  className="pr-1 inline-block"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <svg viewBox="0 0 680 91" className="w-full">
